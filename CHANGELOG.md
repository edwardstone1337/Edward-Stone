...
- **Kaomoji strip copy** (`index.html`): title was the product name while the overline and button already carried it, so the strip said "kaomoji.click" three times and never said what it was for. Now leads with the value proposition in the sibling strips' first-person voice ("There was never an emoji for what I'm feeling, so I made kaomoji easy to find and send"), with the domain left to the overline. Em dashes dropped from the description in favour of a colon and full stops.
