      ...
      <div class="dp-lightbox-sidebar">
        <div class="dp-resume-download" data-download-widget>
          ...
          <div class="dp-dropdown-menu dp-download-menu" role="menu" hidden>
            ...
            <a role="menuitem" class="dp-download-menu-item" href="files/Edward Stone Resume.docx" download data-docx-download>
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
                <path d="M9.5 2H4.5A1.5 1.5 0 0 0 3 3.5v9A1.5 1.5 0 0 0 4.5 14h7a1.5 1.5 0 0 0 1.5-1.5V5.5L9.5 2z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/>
                <path d="M9.5 2v3.5H13" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/>
              </svg>
              <span>Word (.docx)</span>
            </a>
